...
public class MusicFacadePlaylistTest {
    ...
    public void testGetPlaylistsByUserId() {
        ...
        List<Playlist> playlists = musicFacade.getPlaylistsByUserId(1);
    ...
    public void testGetMusicByPlaylistId() throws Exception {
        List<Music> mockMusicList = new ArrayList<>();
        ...
        List<Music> musicList = musicFacade.getMusicByPlaylistId(1);
